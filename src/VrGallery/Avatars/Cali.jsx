...
export function Cali(props) {
  const { nodes, materials } = useGLTF('/models/chars/Cali.glb')
    ...
    <group {...props} dispose={null} ref={group}  position={[-3,1,0]} rotation={[5,0,0]} >
     <group onClick={play} rotation={[Math.PI/2,0,0]} position={[0,-0.21,1.4]}  >
      ...
      <planeGeometry args={[0.2,0.07]}  />
        ...
        <Text fontSize={0.04} color={"white"} position={[0,0,0.01]} >Ali</Text>
      </group>
...
useGLTF.preload('/models/chars/Cali.glb')
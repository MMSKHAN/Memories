...
export function Ali(props) {
  const { nodes, materials } = useGLTF('/models/chars/ali.glb')
  ...
  return (
    <group {...props} dispose={null}  ref={group}  position={[-3,1,0]} rotation={[5,0,0]} >
      ...
      <planeGeometry args={[0.3,0.07]}  />
        ...
        <Text fontSize={0.04} color={"white"} position={[0,0,0.01]} >Ali Hamza</Text>
      </group>
...
useGLTF.preload('/models/chars/ali.glb')

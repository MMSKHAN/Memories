...
export function Rashid(props) {
  const { nodes, materials } = useGLTF('/models/chars/rashid.glb')
  ...
  return (
    <group {...props} dispose={null} ref={group}  position={[-3,1,0]} rotation={[5,0,0]} >
      ...
      <planeGeometry args={[0.2,0.07]}  />
        ...
        <Text fontSize={0.04} color={"white"} position={[0,0,0.01]} >Rashid</Text>
      </group>
...
useGLTF.preload('/models/chars/rashid.glb')
